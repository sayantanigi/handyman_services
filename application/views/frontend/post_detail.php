...
?>
<style>
    .postdetail { padding: 7px 33px; border-radius: 10px; background: red; color: #fff; margin: 10px; font-size: 20px; } .cstm_viewbid_btn { background: linear-gradient(180deg, rgba(249, 80, 30, 1) 0%, rgba(252, 119, 33, 1) 100%) !important; border: 0; border-radius: 35px; letter-spacing: 0; font-weight: 600; width: 100%; display: block; color: #fff; padding: 10px; text-align: center; } .Comment_Block { display: flex; flex-direction: row; align-items: flex-start; justify-content: flex-start; margin: 20px 0; } .Comment_Block .Comment_Img { width: 10%; } .Comment_Block .Comment_Img img { width: 60px; height: 60px; object-fit: cover; border-radius: 100%; } .Comment_Block .Comment_Data { width: 90%; display: flex; flex-direction: column; } .Comment_Block .Comment_Data p:nth-child(1) { margin: 0; font-weight: 600; color: #000 !important; font-size: 16px; } .Comment_Block .Comment_Data p:nth-child(2) { margin: 0; color: #000 !important; font-size: 14px; line-height: normal; } .Comment_Block .Comment_Data ul { margin: 0; display: flex; align-items: center; justify-content: flex-start; width: 150px; margin-top: 10px; }
                ...
                <div class="user-dashboard">
                    <div class="row row-sm">
                        ...
                        <div class="col-4">
                            ...
                            <div class="col-12" style="margin-top: 30px; position: sticky; top: 160px; height: fit-content;">
