                        ...
                        <?php if (@$_SESSION['afrebay']['userType'] == '1') { ?>
                            ...
                            <?php } else if (@$_SESSION['afrebay']['userType'] == '2') { ?>
                                ...
                                <?php } else { ?>
                                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-12">
                                    <?php } ?>
                                    <div class="bid-dis" style="height: 100%;">
                                                        ...
                                                        ?>
                                                                <div class="Comment_Block" style="background: #ffede3; padding: 15px;border-radius: 15px;">
                                                                    ...
                                                                    <div class="Comment_Data">
                                                                        ...
                                                                        <div style="display: flex; flex-direction: row; align-items: flex-start; justify-content: space-between; margin-top: 10px;">
                                                                            <textarea style="background: white !important; font-size: 14px; margin-bottom: 0 !important; float: unset !important; padding: 10px 10px !important; border-bottom: 2px solid #b1b1b1; border-radius: 10px !important; min-height: 50px !important; width: 80%;" required="" name="comment" id="comment" placeholder="Comment"></textarea>
                                                                            <a href="" style="margin-top: 10px; background: linear-gradient(180deg, rgba(249, 80, 30, 1) 0%, rgba(252, 119, 33, 1) 100%); border: 0; border-radius: 100px; width: 15%; height: 40px; cursor: pointer; display: flex; align-items: center; justify-content: center;">
                                                                                <span style="font-size: 12px; font-weight: 600; letter-spacing: 0; color: #fff;">Comment</span>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
...
<script>
    ...
    function replyComment(id) {
        $('html, body').animate({
            scrollTop: $(".blog__comment").offset().top - 180
        }, 0);
        $('#comment_id').val(id)
    }
</script>